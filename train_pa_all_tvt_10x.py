...
PROJECT_NAME = f"dataset-all-tvt-10x-{precision}_GNN" # or allele 
...
# ------------------------
    # old section, before confusion matrix implementation:
...
# ======================================================================    
    path_test = f"./processed_data/PA_all_tvt_10x/{precision}_test.csv"
    # or 
