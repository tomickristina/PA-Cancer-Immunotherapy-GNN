...
PROJECT_NAME = f"dataset-{precision}_GNN" # or allele 
...
dataset_names = [f"{precision}_fold_0.csv",f"{precision}_fold_1.csv",
                f"{precision}_fold_2.csv",f"{precision}_fold_3.csv",
                f"{precision}_fold_4.csv"]
